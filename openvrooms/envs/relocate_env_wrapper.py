...
# transform OpenRelocate env to gym and ALL env
...
def test_env():
    ...
    env = OpenRelocateEnvironment(gym_id="openrelocate-v0", config_file=os.path.join(config_path,'turtlebot_relocate.yaml'), mode="headless", action_timestep=1.0 / 10.0, physics_timestep=1.0 / 40.0, frame_stack=4, save_path=save_path, save_format='mp4')
