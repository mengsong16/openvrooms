...
class ObjectUrdfBuilder:
    ...
    # Do a convex decomposition by trimesh or pybullet
    ...
    # Save an arbitrary input file as an .obj file
    # This will automatically compute mesh.centroid, mesh.center_mass, decompose the mesh ...
    ...
    def update_urdf(self, object_file, object_name, collision_file=None, override=None, mass=None, mass_center=None):
        # If no separate collision geometry is provided, use the .obj file
        ...
        # Output the mass if provided
        if mass is not None:
            self.replace_urdf_attribute(new_urdf,'.//inertial/mass', 'value', str(mass))

        # Output the center of mass if provided
        if mass_center is not None:
            # Check if there's a geometry translation and rotation in the collision item of the template file 
            ...
            # Check if there's a scale factor in the collision item of the template file 
    ...
    def build_urdf(self, filename, output_folder=None,
                   ...
                   mass=None, center='geometric', **kwargs):
        ...
        # rel: basketball_corrected.obj
        # name: basketball_corrected    
        ...
        # get the specified face as mass center
        ...
        if decompose_concave:
            ...
            urdf_out = self.update_urdf(rel, name, override=overrides, mass=mass, mass_center=mass_center)
