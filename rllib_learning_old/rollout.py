...
def rollout(agent,
    ...
    while keep_going(steps, num_steps, episodes, num_episodes):
        ...
        episode_energy = env.get_current_episode_robot_energy_cost()
        energy_total += episode_energy
        print("Episode #{}: reward: {}".format(episodes, reward_total))
        print('Episode energy cost: %f'%(episode_energy))
        print("---------------------------------------------------------------------------")
        if done:
            episodes += 1

    print("---------------------------------------------------------------------------")
    print("Evaluate episodes: %d"%(episodes))        
    print("Mean return: %f"%(return_total / float(episodes)))
    print("Mean energy cost: %f"%(energy_total / float(episodes)))
    print("---------------------------------------------------------------------------")        
